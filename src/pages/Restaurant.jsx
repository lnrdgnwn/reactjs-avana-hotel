import RestaurantBackground from "../assets/img/restaurant.jpg";
      ...
      <div className="container mx-auto py-24">
        <div className="flex flex-col lg:flex-row h-full">
          <div className="w-full h-full lg:w-[60%] px-6">
            ...
            <p className="mb-8"></p>
            <div className="mt-12">
              <h3 className="h3">Avana Restaurant</h3>
              <p className="mb-12">
          ...
          <div className="w-full h-full lg:w-[40%] px-6">
            <div className="flex flex-col space-y-4 mb-4">
              <div>
                ...
                <p className="mb-6">
                  Brunch Asian Fusion Buffet Every Saturday, Sunday, and Public
                  Holiday @ IDR 498,000 net/pax Enjoy a variety of Asian
                  delicacies, from sushi and ramen to grilled BBQ. Starting From
                  10:00 AM – 2:30 PM
                </p>
                <ul className="flex flex-col gap-y-4">
                  ...
                  <li className="flex items-center gap-x-4">
                    <div className="flex self-start py-1 restaurant-icon">
